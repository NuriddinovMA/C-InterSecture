...
java -jar juicertools.jar dump oe *NONE* -v path_to_hic **chrN1** **chrN2** BP 25000 _your_path_/raw/**chrN1**.**chrN2**.something_other
* for *normed* matrix (can use any normalization): 

java -jar juicertools.jar dump oe *KR* -v path_to_hic **chrN1** **chrN2** BP 25000  _your_path_/normed/**chrN1**.**chrN2**.something_other
